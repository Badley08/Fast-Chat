    ...
    if (firebaseUser) {
        ...
        if (userDoc.exists()) {
            ...
            currentUser = {
                ...
                icon: data.icon || (firebaseUser.isAnonymous ? 'user-secret' : 'user'),
            ...
            currentUser = {
                ...
                color: '#1EA7FF',
                icon: firebaseUser.isAnonymous ? 'user-secret' : 'user',
                isAnonymous: firebaseUser.isAnonymous
            };
        }
...
export const loginAnonymously = async (username, color, icon) => {
